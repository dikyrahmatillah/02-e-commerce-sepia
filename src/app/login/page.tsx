        ...
        <div className="rounded-[28px] border border-[#efe2db] bg-white px-6 py-12 shadow-[0_20px_50px_rgba(160,114,90,0.14)] sm:px-12">
          <form className="mx-auto flex max-w-xl flex-col gap-6">
            <label className="text-sm font-semibold text-[#2b1d17]">
              ...
              <span className="text-[#8b4a2f]">*</span>
              <input
                type="text"
                name="username"
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <label className="flex items-center gap-2 text-sm text-[#6e5146]">
                <input
                  type="checkbox"
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 text-sm">
              <Link href="#" className="text-[#8b4a2f] underline">
                Lost your password?
              </Link>
              <Link href="/register" className="text-[#6e5146] underline">
                Create an account
              </Link>
            </div>
          </form>
